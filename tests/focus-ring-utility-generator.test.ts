...
describe("FocusRingUtilityGenerator", () => {
  test("basic usage", () => {
    ...
    expect(generator.css()).toEqualIgnoringWhitespace(`
      ...
      [data-focus-ring='neutral']:focus-visible { outline: var(--border-width-thin) var(--border-style-solid) var(--color-neutral-300); outline-offset: var(--border-width-thin); }
      ...
      @media (max-width: 768px) {
        ...
        [data-md-focus-ring='neutral']:focus-visible { outline: var(--border-width-thin) var(--border-style-solid) var(--color-neutral-300); outline-offset: var(--border-width-thin); }
