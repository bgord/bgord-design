...
describe("BorderColorUtilityGenerator", () => {
  test("basic usage", () => {
    ...
    expect(generator.css()).toEqualIgnoringWhitespace(`
      ...
      [data-bc='neutral-100'] { border-color: var(--color-neutral-100); border-style: solid; } [data-bct='neutral-100'] { border-top-color: var(--color-neutral-100); border-top-style: solid; }
